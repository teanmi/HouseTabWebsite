...
function PrivacyPolicyContent() {
    return (
        <>
            ...
            <p>
                HouseTab (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy
                explains how your personal information is collected, used, and disclosed by
                HouseTab.
            </p>
            <p>
                If you want to delete your HouseTab account, use the <Link href="/delete-account">account deletion page</Link>.
            </p>
            <p>
                This Privacy Policy applies to our website, and its associated subdomains (collectively, our &quot;Service&quot;) alongside our
                application,
                HouseTab. By accessing or using our Service, you signify that you have read, understood, and agree to
            ...
            <p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are referenced,
            ...
            <ul>
                <li>Cookie: small amount of data generated by a website and saved by your web browser. It is used to identify your
                    browser, provide analytics, remember information about you such as your language preference or login information.</li>
                <li>Company: when this policy mentions &quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our,&quot; it refers to
                    HouseTab, that is responsible for your information under this Privacy Policy.</li>
                <li>Country: where
                    HouseTab or the owners/founders of
                    HouseTab are based, in this case is United States</li>
                <li>Customer: refers to the company, organization or person that signs up to use the
                    HouseTab Service to manage the relationships with your consumers or service users.</li>
                <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to
                    visit
                    HouseTab and use the services.</li>
                ...
                <li>Personnel: refers to those individuals who are employed by
                    HouseTab or are under contract to perform a service on behalf of one of the parties.</li>
                ...
                <li>Service: refers to the service provided by
                    HouseTab as described in the relative terms (if available) and on this platform.</li>
                ...
                <li>Website:
                    HouseTab&apos;s site, which can be accessed via this URL:</li>
                <li>You: a person or entity that is registered with
                    HouseTab to use the Services.</li>
            </ul>

            <h1>What Information Do We Collect?</h1>
            <p>We collect information from you when you visit our app, register on our site, place an order, subscribe to our
                newsletter, respond to a survey or fill out a form.</p>
            <ul>
                <li>Name / Username</li><li>Phone Numbers</li><li>Email Addresses</li><li>Mailing Addresses</li><li>Password</li>
            </ul>
            ...
            <h1>When does HouseTab use end user information from third parties?</h1>
            <p>HouseTab will collect End User Data necessary to provide the HouseTab services to our customers.</p>
            ...
            <h1>When does HouseTab use customer information from third parties?</h1>
            <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a HouseTab customer, we receive information from a third party that provides automated fraud detection services to HouseTab. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
            ...
            <p>HouseTab will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
            ...
            <p>The rights you have to request updates or corrections to the information HouseTab collects depend on your relationship with HouseTab. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
            ...
            <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of HouseTab or any of its Corporate Affiliates (as defined herein), or that portion of HouseTab or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

            <h1>Affiliates</h1>
            <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, &quot;Corporate Affiliate&quot; means any person or entity which directly or indirectly controls, is controlled by or is under common control with HouseTab, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
            ...
            <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by HouseTab. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website's own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
            <h1>Advertising</h1>
            <p>This app may contain third party advertisements and links to third party sites. HouseTab does not make any representation as to the accuracy or suitability of any of the information contained in those advertisements or sites and does not accept any responsibility or liability for the conduct or content of those advertisements and sites and the offerings made by the third parties.</p>
            <p>Advertising keeps HouseTab and many of the websites and services you use free of charge. We work hard to make sure that ads are safe, unobtrusive, and as relevant as possible.</p>
            <p>Third party advertisements and links to other sites where goods or services are advertised are not endorsements or recommendations by HouseTab of the third party sites, goods or services. HouseTab takes no responsibility for the content of any of the ads, promises made, or the quality/reliability of the products or services offered in all advertisements.</p>
            ...
            <p>You acknowledge and agree that HouseTab shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. HouseTab does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
            ...
            <ul>
                <li>Cookies<br /><br /><p>We use Cookies to enhance the performance and functionality of our platform but are non-essential to their use. However, without these cookies, certain functionality like videos may become unavailable or you would be required to enter your login details every time you visit the platform as we would not be able to remember that you had logged in previously.</p></li><br />
                <li>Local Storage<br /><br /><p>Local Storage sometimes known as DOM storage, provides web apps with methods and protocols for storing client-side data. Web storage supports persistent data storage, similar to cookies but with a greatly enhanced capacity and no information stored in the HTTP request header.</p></li><br />
                <li>Sessions<br /><br /><p>We use &quot;Sessions&quot; to identify the areas of our website that you have visited. A Session is a small piece of data stored on your computer or mobile device by your web browser.</p></li><br />
            </ul>
        ...
        <main className="min-h-screen bg-slate-50 px-6 py-10 text-slate-900">
            <article className="privacy-policy mx-auto w-full max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_24px_80px_rgba(15,23,42,0.08)] sm:p-12 [&_h1]:mt-8 [&_h1]:mb-3 [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:tracking-tight [&_p]:mb-4 [&_p]:text-base [&_p]:leading-7 [&_p]:text-slate-700 [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:my-1 [&_li]:text-base [&_li]:leading-7 [&_li]:text-slate-700 [&_a]:text-blue-600 [&_a]:underline [&_a]:underline-offset-4">
                <div className="mb-8 flex justify-end">
                    <Link
                        href="/"
                        className="inline-flex items-center rounded-full border border-slate-200 px-4 py-2 text-sm font-medium !text-slate-700 !no-underline transition hover:border-slate-300 hover:bg-slate-50"
                    >
                        Home
                    </Link>
                </div>
